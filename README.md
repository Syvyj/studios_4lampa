...
**EN**: This plugin is strictly a content catalog and metadata aggregator using the TMDB API. It **does not** host, provide links to, or facilitate the streaming of copyrighted, pirated, or illegal video content. All media information is for informational and organizational purposes only.

**UA**: Цей плагін є виключно каталогом контенту та агрегатором метаданих на основі TMDB API. Він **не містить**, не надає посилань та не сприяє перегляду піратського або будь-якого іншого нелегального відеоконтенту. Уся інформація про медіафайли надається виключно в ознайомчих цілях для зручної організації каталогу.
